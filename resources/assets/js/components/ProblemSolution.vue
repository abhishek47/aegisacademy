...
<script type="text/javascript">
    ...
    export default {
        ...
        methods: {
            upvote() {
                var self = this;
                axios.post('/problem-question/solution/' + this.solution.id + '/upvote').then(function(){
                    self.upvoted = true;
                    self.upvotes += 1;
                });
            },
            ...
            downvote() {
                var self = this;
                axios.post('/problem-question/solution/' + this.solution.id + '/downvote').then(function(){
                    self.upvoted = false;
                    self.upvotes -= 1;
                });
            },
            ...
            updateComment() {
               ...
               axios.put('/problem-question/solution/' + this.solution.id, {comment: this.comment}).then(function(){
                    self.editing = false;
                });
            },
            ...
            deleteComment(){
                var self = this;
                   ...
                   axios.delete('/problem-question/solution/' + this.solution.id).then(function(){
                        self.deleted = true;
                    });
