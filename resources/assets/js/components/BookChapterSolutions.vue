<template>
    ...
    <div class="mt-6 p-3">
        ...
        <div v-for="usersolution in solutions">
            <chapter-solution :solution="usersolution"></chapter-solution>
        </div>
...
<script>
    ...
    import BookChapterSolution from './BookChapterSolution.vue';
    ...
    export default {
        ...
        components: {
            'chapter-solution': BookChapterSolution
        },

        created() {
            var self = this;
            axios.get('/book-chapter-question/' + this.questionId + '/solutions').then(function(response){
        ...
        methods: {
            submitComment(){
                var self = this;
                axios.post('/book-chapter-question/' + this.questionId + '/solutions', {comment: this.comment}).then(function(response){
