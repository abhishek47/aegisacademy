...
<div class="container mx-auto mt-8 mb-8">
   <div class="w-3/4 fullwidth mx-auto flex flex-col items-stretch">
      ...
      <div class="flex-1 mt-6">
         <form method="GET" action="/wiki">
            <div class=" serachbar  formres fullwidth w-3/5 mx-auto bg-white shadow-md rounded border-2 border-grey" style="display: flex;">
               <i class="fa fa-search text-xl mt-4 ml-3" ></i>
      ...
      <div class="flex fullwidth items-center mt-8 pt-8 justify-center">
...
<div class="bg-grey-lightest py-60">
   <div class="mb-60">
      <h2 class="text-4xl text-center text-brand mb-8 tracking-wide leading-normal capitalize font-semibold">
         <b>Wiki Articles &ndash; Learn with reading</b>
      </h2>
   </div>
   <div class="container mx-auto flex mt-8" style="flex-wrap: wrap;">
      @foreach($wikis as $article)
      <a href="{{ url($article->url)}}" class="no-underline fullwidth text-black w-1/2 pr-6 mb-8">
         <div class="rounded shadow-md bg-white p-6 pt-4 border-t-4 border-b-0 border-r-0 border-l-0 border-brand" style="margin:12px;">
...
<div class="bg-white py-60">
   <div class="container mx-auto flex mt-8 mb-8">
      ...
      <div class="w-2/5 fullwidth pl-60 -mb-8">
...
<div class="bg-white py-60">
   <div class="container mx-auto flex flex-col mt-8 mb-45">
      ...
      <div class="flex justify-between">
         ...
         <div class="bg-white shadow-md rounded w-ful mr-6 md:w-1/2 z-10 border-t-4  border-brand">
