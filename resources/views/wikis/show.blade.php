   ...
   <div id="editor--container" class="hidden">
     ...
     <div>
       <div class="float-right"> 
       	  <a href="#" class="btn btn-danger btn-sm" onclick="toggleEditor()">Cancel</a> &nbsp;
       	  <a href="#" class="btn btn-info btn-sm" onclick="inEdit=true;Preview.Update()">Preview</a> &nbsp;
   ...
   <div id="editor" class="editor--toolbar" style="margin-top: 20px;">
    <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups"> 
        <div class="btn-group" role="group" aria-label="First group"> 
            ...
            <button type="button" title="Add Image" data-toggle="tooltip" class="btn btn-default" onclick="addImage();return false;"><i class="fa fa-image"></i></button> 
