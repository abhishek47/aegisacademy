...
class ProblemQuestion extends Model
{
    ...
    */
    ...
    protected $fillable = ['question', 'options', 'solution', 'level', 'hint', 'hint2', 'hint3', 'answer', 'problem_id'];
    // protected $hidden = [];
    // protected $dates = [];
    ...
    {
        return '<a class="btn btn-xs btn-default"   href="/admin/problem-questions/' . $this->id . '/edit?problem=' . $this->problem->id . '" data-toggle="tooltip" title="Edit Question"><i class="fa fa-edit"></i> Edit</a>';
    }

     public function addQuestion()
    {
        return '<a class="btn btn-md btn-primary"   href="/admin/problem-questions/create?problem=' . request('problem') . '" data-toggle="tooltip" title="Add Question"><i class="fa fa-plus"></i> Add New Question</a>';
    }
    ...
    public function deleteQuestion()
    {
        ...
        return '<a href="javascript:void(0)"  class="btn btn-xs btn-default" onclick="deleteEntry(this)" data-route="/admin/problem-questions/' . $this->id  .'"class="btn btn-xs btn-default" data-button-type="delete"><i class="fa fa-trash"></i> Delete</a><script>
