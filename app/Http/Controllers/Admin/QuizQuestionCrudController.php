...
use App\Http\Requests\QuizQuestionRequest as StoreRequest;
use App\Http\Requests\QuizQuestionRequest as UpdateRequest;

/**
 * Class QuizQuestionCrudController
...
class QuizQuestionCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/quiz_questions');
        $this->crud->setEntityNameStrings('quizquestion', 'quiz_questions');
        ...
        // add asterisk for fields that are required in QuizQuestionRequest
