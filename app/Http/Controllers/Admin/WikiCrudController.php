...
use App\Http\Requests\WikiRequest as StoreRequest;
use App\Http\Requests\WikiRequest as UpdateRequest;

/**
 * Class WikiCrudController
...
class WikiCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Wiki');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/wikis');
        $this->crud->setEntityNameStrings('Wiki Page', 'Wiki Pages');
        ...
        */
        ...
        $this->crud->addFields([
            ...
            [  // Select2
               'label' => "Category",
               'type' => 'select2',
               'name' => 'wiki_category_id', // the db column for the foreign key
